...
import com.example.demo.web.modem.request_handlers.requests.ATMessagesRequest;
import com.example.demo.web.modem.request_handlers.requests.ATRequest;

public class ATMessagesRequestFactory implements ATRequestFactory {
    @Override
    public ATRequest getATRequest() {
        return new ATMessagesRequest();
    }
